...
def average(vals:list, func=mean) -> int:
    """
    Takes an iterable and calls the provided averaging function (default mean) on it.

    :param vals: Iterable of ints and/or floats.
    :param fun: Averaging function.
    :return: Returns an int if there is a single average value
        else a list.
    """
